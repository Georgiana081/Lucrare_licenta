...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "DELETE comanda, produs_comanda 
            FROM comanda, produs_comanda 
            WHERE comanda.id = ? 
            AND produs_comanda.id_comanda = ?;";
    
    if($stmt = mysqli_prepare($link, $sql)){
        mysqli_stmt_bind_param($stmt, "ii", $param_id, $param_id2);
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            <p>Sigur dorești să ștergi această comandă?</p>
                            <p>
                                <input type="submit" value="Da" class="btn btn-danger">
                                <a href="comenzi.php" class="btn btn-secondary">Nu</a>
                            </p>
                        </div>
                    </form>
                </div>
